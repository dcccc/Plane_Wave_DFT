...
第三行设定使用泛函名称设定使用的libxc中的泛函方法，未安装pylibxc[2]或者未设定该参数则默认使用xalpha泛函[3]. 目前支持LDA、GGA、MGGA，杂化泛函和范围分离杂化泛函。具体设置可以参考example文件夹中的输入文件
...
5. r2scan泛函计算的结果与quantum espresso计算的结果之间存在较小的差别，具体原因暂时未知
